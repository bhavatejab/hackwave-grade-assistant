...
export const evaluationService = {
  ...
  // POST /api/ocr/upload-and-grade
  uploadAndGradeAnswerSheet: async (formData: FormData): Promise<any> => {
    const response = await apiClient.post<any>('/api/ocr/upload-and-grade', formData, {
      headers: { 'Content-Type': 'multipart/form-data' },
    })
    return response.data
  },
